...
@interface LTOBD2PID_TERM_SECONDARY_OXYGEN_SENSOR_TRIM : LTOBD2PID

+(instancetype)pid NS_UNAVAILABLE;

@end

@interface LTOBD2PID_SHORT_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_13_55 : LTOBD2PID_TERM_SECONDARY_OXYGEN_SENSOR_TRIM
@end

@interface LTOBD2PID_LONG_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_13_56 : LTOBD2PID_TERM_SECONDARY_OXYGEN_SENSOR_TRIM
@end

@interface LTOBD2PID_SHORT_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_24_57 : LTOBD2PID_TERM_SECONDARY_OXYGEN_SENSOR_TRIM
@end

@interface LTOBD2PID_LONG_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_24_58 : LTOBD2PID_TERM_SECONDARY_OXYGEN_SENSOR_TRIM
@end
...
@interface LTOBD2PID_ENGINE_PERCENT_TORQUE_DATA_64 : LTOBD2PID

+(instancetype)pid NS_UNAVAILABLE;

@end

@interface LTOBD2PID_DPF_TEMPERATURE_7C : LTOBD2PIDDoubleByteTemperature

+(instancetype)pid NS_UNAVAILABLE;

@end

@interface LTOBD2PID_THROTTLE_POSITION_G_8D : LTOBD2PIDSingleBytePercent

+(instancetype)pid NS_UNAVAILABLE;

@end

@interface LTOBD2PID_ENGINE_FRICTION_PERCENT_TORQUEE_8E : LTOBD2PID
...
@interface LTOBD2PID_NOX_SENSOR_CORRECTED_DATA_A1 : LTOBD2PID

+(instancetype)pid NS_UNAVAILABLE;

@end

@interface LTOBD2PID_CYLINDER_FUEL_RATE_A2 : LTOBD2PID
...
@interface LTOBD2PID_SUPPORTED_PIDS_MODE_5_050100 : LTOBD2PID
